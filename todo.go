...
func (todo Todo) RetrieveStatus(creds Repo) (string, error) {
	json, err := creds.getIssue(todo)
...
func (todo Todo) Report(creds Repo, body string) (Todo, error) {
	return creds.postIssue(todo, body)
}
